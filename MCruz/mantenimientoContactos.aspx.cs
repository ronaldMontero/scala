        ...
        protected void listadoClientes_ItemCommand(object sender, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case ("Asociar"):
                    ...
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "sendMessage", "sendMessage('info', 'Asociación se completará al guardar toda la información');", true);
                    break;
            }
        }
